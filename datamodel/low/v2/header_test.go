...
`
	...
	assert.Nil(t, n.GetDeprecated())
	assert.Nil(t, n.GetSchema())
	assert.Nil(t, n.GetAllowReserved())
	assert.Nil(t, n.GetExplode())
	assert.Nil(t, n.GetExample())
	assert.Nil(t, n.GetExamples())
	assert.Nil(t, n.GetContent())
	assert.Nil(t, n.GetRequired())
	assert.Nil(t, n.GetAllowEmptyValue())
	assert.Nil(t, n.GetStyle())
